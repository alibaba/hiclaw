...
4. Notify Worker in their Room:
   ...
   ```
   If Worker has `find-skills` (`test -d /root/hiclaw-fs/agents/{worker}/skills/find-skills`), add: `Run \`hiclaw-find-skill find <keyword>\` if you need additional capabilities.`
